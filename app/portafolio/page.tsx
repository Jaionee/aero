        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <a className="group block" href="#">
            <div className="relative pt-[50%] sm:pt-[70%] rounded-xl overflow-hidden">
              <img className="size-full absolute top-0 start-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-xl" src="/MGFdQesCmtQHJ39j.jpeg" alt="Image Description"/>
            </div>
            <div className="mt-7">
          ...
          <a className="group block" href="#">
            <div className="relative pt-[50%] sm:pt-[70%] rounded-xl overflow-hidden">
              <img className="size-full absolute top-0 start-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-xl" src="/hl80FYi8G13jT7n1.jpeg" alt="Image Description"/>
            </div>
            <div className="mt-7">
          ...
          <a className="group block" href="#">
            <div className="relative pt-[50%] sm:pt-[70%] rounded-xl overflow-hidden">
              <img className="size-full absolute top-0 start-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-xl" src="/0zIucWrjakgCUPD0.jpeg" alt="Image Description"/>
            </div>
            <div className="mt-7">
